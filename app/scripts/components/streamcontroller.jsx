...
export default class StreamController extends Component {
  ...
  render() {
    return (
        ...
        <input type="search" placeholder="Add Stream" onKeyPress={(event)=>this.addStream(event)}></input>
        ...
        <button type="button" className="togglebutton" onClick={()=>this.toggleSideBar()}>></button>
        </div>
